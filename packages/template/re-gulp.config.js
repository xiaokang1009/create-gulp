module.exports = {
  normal: {
    ...
    inputLib: "src/lib/**/*",
    cssSplitBeforeSrc: /\.\.\/images\//g, //样式文件分离前的路径
    jsSplitBeforeSrc: /\.\/images\//g, //js文件分离前的路径
    htmlSplitBeforeSrc: /\.\/images\//g, //html文件分离前的路径
    inputSrc: "src",
    imageName: "images"
  },
  dev: {
  ...
  prod: {
    // 生产环境
    imgIgnore: "src/images/sprite/*.{png,jpg}", // 忽略需要合成的精灵图文件
    outputDir: "dist",
    isBabel: true,
    isSprite: true,
