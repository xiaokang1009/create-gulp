...
var generator = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(projectName) {
    var templateDir;
...
var create = exports.create = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(projectName) {
    var targetDir, isExist, _yield$inquirer$promp, isCover;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          // 判断是否存在同名文件夹
          targetDir = _path["default"].resolve(process.cwd(), projectName);
          _context2.next = 3;
          return _fsExtra["default"].pathExists(targetDir);
        case 3:
        ...
        case 7:
          ...
          isCover = _yield$inquirer$promp.isCover;
          if (!isCover) {
            _context2.next = 12;
            break;
          }
          _context2.next = 12;
          return _fsExtra["default"].remove(targetDir);
        case 12:
          _context2.next = 14;
